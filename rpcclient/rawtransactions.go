...
func (r FutureGetRawTransactionResult) Receive() (*cashutil.Tx, error) {
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*cashutil.Tx, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []btcjson.TransactionInput,
	amounts map[cashutil.Address]cashutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {
...
func (c *Client) CreateRawTransaction(inputs []btcjson.TransactionInput,
	amounts map[cashutil.Address]cashutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactions(address cashutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerbose(address cashutil.Address, skip,
