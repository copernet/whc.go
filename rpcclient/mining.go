...
func (c *Client) SubmitBlockAsync(block *cashutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *cashutil.Block, options *btcjson.SubmitBlockOptions) error {
